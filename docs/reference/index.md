...
- [`newConstraint()`](https://energyRt.org/reference/newConstraint.md)
  [`isConstraint()`](https://energyRt.org/reference/newConstraint.md)
...
- [`newCalendar()`](https://energyRt.org/reference/newCalendar.md) :
  Generate a new calendar object from
- [`plot(`*`<calendar>`*`)`](https://energyRt.org/reference/plot_calendar_method.md)
...
- [`newHorizon()`](https://energyRt.org/reference/newHorizon.md)
  ...
  [`update(`*`<config>`*`)`](https://energyRt.org/reference/newHorizon.md)
  : Create a new object of class 'horizon'
- [`plot(`*`<horizon>`*`)`](https://energyRt.org/reference/plot_horizon_method.md)
...
- [`interpolate_bounds()`](https://energyRt.org/reference/interpolate_bounds.md)
...
- [`interpolate_numpar()`](https://energyRt.org/reference/interpolate_numpar.md)
  : Interpolate numerical parameter for missing years

- [`interpolate_parameters()`](https://energyRt.org/reference/interpolate_parameters.md)
...
- [`write_script()`](https://energyRt.org/reference/write.md)
  ...
  [`write.sc()`](https://energyRt.org/reference/write.md) : Write
...
- [`mappings_by_recipe()`](https://energyRt.org/reference/mappings_by_recipe.md)
...
- [`neos_ping()`](https://energyRt.org/reference/neos.md)
  [`neos_list_categories()`](https://energyRt.org/reference/neos.md)
  [`neos_list_solvers()`](https://energyRt.org/reference/neos.md)
  [`neos_get_template()`](https://energyRt.org/reference/neos.md) : NEOS
...
- [`neos_build_gams_text_job()`](https://energyRt.org/reference/neos_build_gams_text_job.md)
  : Build a NEOS GAMS job from a text-mode scenario directory (no input
  GDX)
...
- [`neos_submit_job()`](https://energyRt.org/reference/neos_job.md)
  [`neos_job_status()`](https://energyRt.org/reference/neos_job.md)
  [`neos_completion_code()`](https://energyRt.org/reference/neos_job.md)
  [`neos_final_results()`](https://energyRt.org/reference/neos_job.md)
  [`neos_get_output_file()`](https://energyRt.org/reference/neos_job.md)
  [`neos_wait()`](https://energyRt.org/reference/neos_job.md) : Submit
  and manage a NEOS job
...
- [`en_replace_specials()`](https://energyRt.org/reference/en_replace_specials.md)
  [`en_has_specials()`](https://energyRt.org/reference/en_replace_specials.md)
  [`en_find_specials()`](https://energyRt.org/reference/en_replace_specials.md)
...
- [`tsl2year()`](https://energyRt.org/reference/tsl2dtm.md)
  ...
  function between time-slices and day of the year

- [`tsl_guess_format()`](https://energyRt.org/reference/tsl_guess_format.md)
  : Guess format of time-slices

- [`drop_na_cols()`](https://energyRt.org/reference/drop_na_cols.md) :
...
- [`get_registry()`](https://energyRt.org/reference/get_registry.md) :
...
- [`draw()`](https://energyRt.org/reference/draw.md) : Draw a schematic
...
- [`autoplot(`*`<tax>`*`)`](https://energyRt.org/reference/autoplot.lever.md)
  [`autoplot(`*`<sub>`*`)`](https://energyRt.org/reference/autoplot.lever.md)
...
- [`plot_demand()`](https://energyRt.org/reference/plot_demand.md)
  [`autoplot(`*`<demand>`*`)`](https://energyRt.org/reference/plot_demand.md)
...
- [`plot_process_windows()`](https://energyRt.org/reference/plot_process_windows.md)
  [`autoplot(`*`<model>`*`)`](https://energyRt.org/reference/plot_process_windows.md)
  [`autoplot(`*`<repository>`*`)`](https://energyRt.org/reference/plot_process_windows.md)
...
- [`set_scenarios_path()`](https://energyRt.org/reference/options.md)
  [`get_scenarios_path()`](https://energyRt.org/reference/options.md) :
  Set or get directory for/with scenarios
- [`set_progress_bar()`](https://energyRt.org/reference/progress.md)
  [`show_progress_bar()`](https://energyRt.org/reference/progress.md) :
  Switch on/off and select/customize progress bar
- [`get_arrow_format()`](https://energyRt.org/reference/arrow_format.md)
  [`set_arrow_format()`](https://energyRt.org/reference/arrow_format.md)
  [`get_arrow_compression()`](https://energyRt.org/reference/arrow_format.md)
  [`set_arrow_compression()`](https://energyRt.org/reference/arrow_format.md)
...
- [`collect_set_elements()`](https://energyRt.org/reference/collect_set_elements.md)
...
- [`getUnits(`*`<commodity>`*`)`](https://energyRt.org/reference/getUnits.md)
  ...
  [`get_units()`](https://energyRt.org/reference/getUnits.md) : Get
...
- [`get_slot_doc()`](https://energyRt.org/reference/get_slot_doc.md) :
...
- [`set_gams_path()`](https://energyRt.org/reference/solver.md)
  ...
  [`get_python_path()`](https://energyRt.org/reference/solver.md) : Set
  GAMS and GDX library directory
- [`complete_set()`](https://energyRt.org/reference/complete_set.md) :
  Complete a data frame with missing set elements
- [`expand_na_rows()`](https://energyRt.org/reference/expand_na_rows.md)
  [`expand_na_regions()`](https://energyRt.org/reference/expand_na_rows.md)
  [`expand_na_years()`](https://energyRt.org/reference/expand_na_rows.md)
  [`expand_sets()`](https://energyRt.org/reference/expand_na_rows.md) :
  Expand rows with NA values in set columns
- [`countdown_timer()`](https://energyRt.org/reference/countdown_timer.md)
  : Countdown timer to use in R scripts
- [`is_any()`](https://energyRt.org/reference/is_any.md) : Check if an
...
- [`named_list_to_df()`](https://energyRt.org/reference/named_list_to_df.md)
