...
put "stg,comm,region,year,timeslice,value"/;
loop((stg,comm,region,year,timeslice)$(vStorageStore.l(stg,comm,region,year,timeslice) and mMidMilestone(year)), put stg.tl:0",", comm.tl:0",", region.tl:0",", year.tl:0",", timeslice.tl:0","vStorageStore.l(stg,comm,region,year,timeslice):0:15/;);
putclose; 
