...
*eqBalance_ry(comm, region, year)$mvBalance_ry(comm, region, year)..
*  vBalance_ry(comm, region, year)
*  =e=
*  sum(slice,
*        pSliceWeight(year, slice) * vBalance(comm, region, year, slice));
...
*eqOutTot_ry(comm, region, year)$mvOutTot_ry(comm, region, year)..
...
*eqInpTot_ry(comm, region, year)$mvInpTot_ry(comm, region, year)..
...
* IR trade fixed O&M costs
        + sum(trade$mTradeFixom(trade, region, year),
              pTradeFixom(trade, region, year) * vTradeCap(trade, year)$mTradeFixom(trade, region, year))
