...
pStorageAfUp(stg, region, year, timeslice) & $pStorageAfUp_{st1,r,y,s}$ & Storage availability factor upper bound (maximum charging level) \\
 \hline
pStorageCinpUp(stg, comm, region, year, timeslice) & $pStorageCinpUp_{st1,c,r,y,s}$ & Storage input upper bound \\
 \hline
pStorageCinpLo(stg, comm, region, year, timeslice) & $pStorageCinpLo_{st1,c,r,y,s}$ & Storage input lower bound \\
 \hline
pStorageCoutUp(stg, comm, region, year, timeslice) & $pStorageCoutUp_{st1,c,r,y,s}$ & Storage output upper bound \\
 \hline
pStorageCoutLo(stg, comm, region, year, timeslice) & $pStorageCoutLo_{st1,c,r,y,s}$ & Storage output lower bound \\
 \hline
