...
.variable_mapping = list(
  ...
  vTradeRetiredStockCum = "vTradeRetiredStockCum( trade , year ) $ mvTradeRetiredStock( trade , year )",
  ...
  vStorageOutRetiredStockCum = "vStorageOutRetiredStockCum( stg , region , year ) $ mvStorageRetiredStock( stg , region , year )",
  ...
  vStorageInpRetiredStockCum = "vStorageInpRetiredStockCum( stg , region , year ) $ mvStorageRetiredStock( stg , region , year )",
  ...
  vStorageStgRetiredStockCum = "vStorageStgRetiredStockCum( stg , region , year ) $ mvStorageRetiredStock( stg , region , year )",
...
.variable_description = c(
  ...
  vTradeRetiredStockCum = "Early retired trade stock (cumulative)",
  ...
  vStorageOutRetiredStockCum = "Early retired storage discharging stock (cumulative)",
  ...
  vStorageInpRetiredStockCum = "Early retired storage charging stock (cumulative)",
  ...
  vStorageStgRetiredStockCum = "Early retired storage energy (reservoir) stock (cumulative)",
...
.equation_description = c(
  ...
  eqStorageOutRetiredStock = "Retirement of existing storage discharging capacity",
  eqStorageOutRetiredStockCum = "Cumulative retirement of existing storage discharging capacity",
  ...
  eqStorageInpRetiredStock = "Retirement of existing storage charging capacity",
  eqStorageInpRetiredStockCum = "Cumulative retirement of existing storage charging capacity",
  ...
  eqStorageStgRetiredStock = "Retirement of existing storage energy (reservoir) capacity",
  eqStorageStgRetiredStockCum = "Cumulative retirement of existing storage energy (reservoir) capacity",
  ...
  eqTradeRetiredStock = "Retirement of existing trade capacity",
  eqTradeRetiredStockCum = "Cumulative retirement of existing trade capacity",
...
.equation_set = list(
  ...
  eqStorageOutRetiredStock = c("stg", "region", "year"),
  eqStorageOutRetiredStockCum = c("stg", "region", "year"),
  eqStorageOutRetiredNewCap = c("stg", "region", "year"),
  eqStorageOutRetLo = c("stg", "region", "year"),
  eqStorageOutRetUp = c("stg", "region", "year"),
  eqStorageInpRetiredStock = c("stg", "region", "year"),
  eqStorageInpRetiredStockCum = c("stg", "region", "year"),
  eqStorageInpRetiredNewCap = c("stg", "region", "year"),
  eqStorageInpRetLo = c("stg", "region", "year"),
  eqStorageInpRetUp = c("stg", "region", "year"),
  eqStorageStgRetiredStock = c("stg", "region", "year"),
  eqStorageStgRetiredStockCum = c("stg", "region", "year"),
  ...
  eqTradeRetiredStock = c("trade", "year"),
  eqTradeRetiredStockCum = c("trade", "year"),
...
.equation_mapping = list(
  ...
  eqStorageOutRetiredStock = "mvStorageRetiredStock(stg, region, year)",
  eqStorageOutRetiredStockCum = "mvStorageRetiredStock(stg, region, year)",
  ...
  eqStorageInpRetiredStock = "mvStorageRetiredStock(stg, region, year)",
  eqStorageInpRetiredStockCum = "mvStorageRetiredStock(stg, region, year)",
  ...
  eqStorageStgRetiredStock = "mvStorageRetiredStock(stg, region, year)",
  eqStorageStgRetiredStockCum = "mvStorageRetiredStock(stg, region, year)",
  ...
  eqTradeRetiredStock = "mvTradeRetiredStock(trade, year)",
  eqTradeRetiredStockCum = "mvTradeRetiredStock(trade, year)",
...
# Retirement links for storage (three parts) and trade -- the classes that
# gained retirement equations alongside technology's.
.equation_variable <- rbind(.equation_variable, data.frame(
  equation = c("eqStorageOutRetiredStock", "eqStorageOutRetiredStock",
               "eqStorageOutRetiredStockCum", "eqStorageOutRetiredNewCap",
               "eqStorageOutRetiredNewCap", "eqStorageOutRetLo",
               "eqStorageOutRetLo", "eqStorageOutRetUp", "eqStorageOutRetUp",
               "eqStorageOutCap", "eqStorageOutCap", "eqStorageRetCost",
               "eqStorageRetCost", "eqStorageInpRetiredStock",
               "eqStorageInpRetiredStock", "eqStorageInpRetiredStockCum",
               "eqStorageInpRetiredNewCap", "eqStorageInpRetiredNewCap",
               "eqStorageInpRetLo", "eqStorageInpRetLo", "eqStorageInpRetUp",
               "eqStorageInpRetUp", "eqStorageInpCap", "eqStorageInpCap",
               "eqStorageRetCost", "eqStorageRetCost",
               "eqStorageStgRetiredStock", "eqStorageStgRetiredStock",
               "eqStorageStgRetiredStockCum", "eqStorageStgRetiredNewCap",
               "eqStorageStgRetiredNewCap", "eqStorageStgRetLo",
               "eqStorageStgRetLo", "eqStorageStgRetUp", "eqStorageStgRetUp",
               "eqStorageStgCap", "eqStorageStgCap", "eqStorageRetCost",
               "eqStorageRetCost", "eqStorageRetCost", "eqTradeRetiredStock",
               "eqTradeRetiredStock", "eqTradeRetiredStockCum",
               "eqTradeRetiredNewCap", "eqTradeRetiredNewCap", "eqTradeRetLo",
               "eqTradeRetLo", "eqTradeRetUp", "eqTradeRetUp", "eqTradeRetCost",
               "eqTradeRetCost", "eqTradeRetCost", "eqTradeCap", "eqTradeCap"),
  variable = c("vStorageOutRetiredStock", "vStorageOutRetiredStockCum",
               "vStorageOutRetiredStockCum", "vStorageOutRetiredNewCap",
               "vStorageOutNewCap", "vStorageOutRetiredStock",
               "vStorageOutRetiredNewCap", "vStorageOutRetiredStock",
               "vStorageOutRetiredNewCap", "vStorageOutRetiredStockCum",
               "vStorageOutRetiredNewCap", "vStorageOutRetiredStock",
               "vStorageOutRetiredNewCap", "vStorageInpRetiredStock",
               "vStorageInpRetiredStockCum", "vStorageInpRetiredStockCum",
               "vStorageInpRetiredNewCap", "vStorageInpNewCap",
               "vStorageInpRetiredStock", "vStorageInpRetiredNewCap",
               "vStorageInpRetiredStock", "vStorageInpRetiredNewCap",
               "vStorageInpRetiredStockCum", "vStorageInpRetiredNewCap",
               "vStorageInpRetiredStock", "vStorageInpRetiredNewCap",
               "vStorageStgRetiredStock", "vStorageStgRetiredStockCum",
               "vStorageStgRetiredStockCum", "vStorageStgRetiredNewCap",
               "vStorageStgNewCap", "vStorageStgRetiredStock",
               "vStorageStgRetiredNewCap", "vStorageStgRetiredStock",
               "vStorageStgRetiredNewCap", "vStorageStgRetiredStockCum",
               "vStorageStgRetiredNewCap", "vStorageStgRetiredStock",
               "vStorageStgRetiredNewCap", "vStorageRetCost",
               "vTradeRetiredStock", "vTradeRetiredStockCum",
               "vTradeRetiredStockCum", "vTradeRetiredNewCap", "vTradeNewCap",
               "vTradeRetiredStock", "vTradeRetiredNewCap",
               "vTradeRetiredStock", "vTradeRetiredNewCap", "vTradeRetCost",
               "vTradeRetiredStock", "vTradeRetiredNewCap",
               "vTradeRetiredStockCum", "vTradeRetiredNewCap"),
  stringsAsFactors = FALSE))
