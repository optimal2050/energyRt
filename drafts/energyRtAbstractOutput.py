head_val = {
    ...
    "vStorageOutRetiredStockCum": "stg,region,year,value",
    "vStorageOutRetiredStock": "stg,region,year,value",
    "vStorageOutRetiredNewCap": "stg,region,year,year,value",
    "vStorageInpRetiredStockCum": "stg,region,year,value",
    "vStorageInpRetiredStock": "stg,region,year,value",
    "vStorageInpRetiredNewCap": "stg,region,year,year,value",
    "vStorageStgRetiredStockCum": "stg,region,year,value",
    "vStorageStgRetiredStock": "stg,region,year,value",
    "vStorageStgRetiredNewCap": "stg,region,year,year,value",
    "vStorageRetCost": "stg,region,year,value",
    "vTradeRetiredStockCum": "trade,year,value",
    "vTradeRetiredStock": "trade,year,value",
    "vTradeRetiredNewCap": "trade,year,year,value",
    "vTradeRetCost": "trade,region,year,value",
